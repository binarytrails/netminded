...
function pickMovies() {
	...
	for (var i = 0; i < amountsArray.length; i++) {
		...
		pickedMovie = pickRandomizedMovie(newSection);
...
function pickRandomizedMovie(newSection) {
var isInNewLoop = newSection;
var myNumber;
//numbHistory = myHistory;

if (isInNewLoop) {
	myNumber = int(random(29));
	numbHistory.push(myNumber);
	console.log("I'm starting a new section!:: ");
	return myNumber;
	
	} if else {
	// var myCount = 0;
// 	for (var i = 0; i < numbHistory.length; i++) {
// 		myNumber = int(random(29));
// 		if (int(numbHistory[i]) === myNumber) {
// 			myCount++
// 		}
// 	}
// 	if (myCount < 1) {
// 	numbHistory.push(myNumber);
// 	// for (var i = 0; i < numbHistory.length; i++) {
// // 	console.log("array value"+i+" :"+numbHistory[i]);
// // 	}
